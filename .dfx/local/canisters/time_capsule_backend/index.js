...
import { idlFactory } from './time_capsule_backend.did.js';
export { idlFactory } from './time_capsule_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TIME_CAPSULE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./time_capsule_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the time_capsule_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./time_capsule_backend.did.js")._SERVICE>}
 */
export const time_capsule_backend = createActor(canisterId);
